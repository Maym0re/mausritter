...
export const CampaignFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CampaignSelect> = z.object({
...
export const CampaignFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    isActive: z.boolean().optional(),
