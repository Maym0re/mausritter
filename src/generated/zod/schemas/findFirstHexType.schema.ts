...
export const HexTypeFindFirstSelectSchema: z.ZodType<Prisma.HexTypeSelect> = z.object({
...
export const HexTypeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    color: z.boolean().optional(),
    description: z.boolean().optional(),
