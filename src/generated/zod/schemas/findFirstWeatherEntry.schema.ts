...
export const WeatherEntryFindFirstSelectSchema: z.ZodType<Prisma.WeatherEntrySelect> = z.object({
...
export const WeatherEntryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    season: z.boolean().optional(),
    roll: z.boolean().optional(),
    weather: z.boolean().optional(),
...
export const WeatherEntryFindFirstSchema: z.ZodType<Prisma.WeatherEntryFindFirstArgs> = z.object({ select: WeatherEntryFindFirstSelectSchema.optional(), include: z.lazy(() => WeatherEntryIncludeObjectSchema.optional()), orderBy: z.union([WeatherEntryOrderByWithRelationInputObjectSchema, WeatherEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WeatherEntryWhereInputObjectSchema.optional(), cursor: WeatherEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WeatherEntryScalarFieldEnumSchema, WeatherEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WeatherEntryFindFirstArgs>;

export const WeatherEntryFindFirstZodSchema = z.object({ select: WeatherEntryFindFirstSelectSchema.optional(), include: z.lazy(() => WeatherEntryIncludeObjectSchema.optional()), orderBy: z.union([WeatherEntryOrderByWithRelationInputObjectSchema, WeatherEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: WeatherEntryWhereInputObjectSchema.optional(), cursor: WeatherEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WeatherEntryScalarFieldEnumSchema, WeatherEntryScalarFieldEnumSchema.array()]).optional() }).strict();