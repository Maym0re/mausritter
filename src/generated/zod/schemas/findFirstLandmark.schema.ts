...
export const LandmarkFindFirstSelectSchema: z.ZodType<Prisma.LandmarkSelect> = z.object({
...
export const LandmarkFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    hexTypeId: z.boolean().optional(),
