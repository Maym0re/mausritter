...
export const GameTimeFindManySelectSchema: z.ZodType<Prisma.GameTimeSelect> = z.object({
...
export const GameTimeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    campaignId: z.boolean().optional(),
    campaign: z.boolean().optional(),
    rounds: z.boolean().optional(),
...
export const GameTimeFindManySchema: z.ZodType<Prisma.GameTimeFindManyArgs> = z.object({ select: GameTimeFindManySelectSchema.optional(), include: z.lazy(() => GameTimeIncludeObjectSchema.optional()), orderBy: z.union([GameTimeOrderByWithRelationInputObjectSchema, GameTimeOrderByWithRelationInputObjectSchema.array()]).optional(), where: GameTimeWhereInputObjectSchema.optional(), cursor: GameTimeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GameTimeScalarFieldEnumSchema, GameTimeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GameTimeFindManyArgs>;

export const GameTimeFindManyZodSchema = z.object({ select: GameTimeFindManySelectSchema.optional(), include: z.lazy(() => GameTimeIncludeObjectSchema.optional()), orderBy: z.union([GameTimeOrderByWithRelationInputObjectSchema, GameTimeOrderByWithRelationInputObjectSchema.array()]).optional(), where: GameTimeWhereInputObjectSchema.optional(), cursor: GameTimeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GameTimeScalarFieldEnumSchema, GameTimeScalarFieldEnumSchema.array()]).optional() }).strict();