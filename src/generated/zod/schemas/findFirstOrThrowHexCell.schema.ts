...
export const HexCellFindFirstOrThrowSelectSchema: z.ZodType<Prisma.HexCellSelect> = z.object({
...
export const HexCellFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    hexMapId: z.boolean().optional(),
    hexMap: z.boolean().optional(),
    q: z.boolean().optional(),
...
export const HexCellFindFirstOrThrowSchema: z.ZodType<Prisma.HexCellFindFirstOrThrowArgs> = z.object({ select: HexCellFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => HexCellIncludeObjectSchema.optional()), orderBy: z.union([HexCellOrderByWithRelationInputObjectSchema, HexCellOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexCellWhereInputObjectSchema.optional(), cursor: HexCellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexCellScalarFieldEnumSchema, HexCellScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HexCellFindFirstOrThrowArgs>;

export const HexCellFindFirstOrThrowZodSchema = z.object({ select: HexCellFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => HexCellIncludeObjectSchema.optional()), orderBy: z.union([HexCellOrderByWithRelationInputObjectSchema, HexCellOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexCellWhereInputObjectSchema.optional(), cursor: HexCellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexCellScalarFieldEnumSchema, HexCellScalarFieldEnumSchema.array()]).optional() }).strict();