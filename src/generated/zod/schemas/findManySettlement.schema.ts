...
export const SettlementFindManySelectSchema: z.ZodType<Prisma.SettlementSelect> = z.object({
...
export const SettlementFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    size: z.boolean().optional(),
    governance: z.boolean().optional(),
...
export const SettlementFindManySchema: z.ZodType<Prisma.SettlementFindManyArgs> = z.object({ select: SettlementFindManySelectSchema.optional(), include: z.lazy(() => SettlementIncludeObjectSchema.optional()), orderBy: z.union([SettlementOrderByWithRelationInputObjectSchema, SettlementOrderByWithRelationInputObjectSchema.array()]).optional(), where: SettlementWhereInputObjectSchema.optional(), cursor: SettlementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SettlementScalarFieldEnumSchema, SettlementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SettlementFindManyArgs>;

export const SettlementFindManyZodSchema = z.object({ select: SettlementFindManySelectSchema.optional(), include: z.lazy(() => SettlementIncludeObjectSchema.optional()), orderBy: z.union([SettlementOrderByWithRelationInputObjectSchema, SettlementOrderByWithRelationInputObjectSchema.array()]).optional(), where: SettlementWhereInputObjectSchema.optional(), cursor: SettlementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SettlementScalarFieldEnumSchema, SettlementScalarFieldEnumSchema.array()]).optional() }).strict();