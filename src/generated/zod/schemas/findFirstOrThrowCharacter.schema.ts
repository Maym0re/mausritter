...
export const CharacterFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CharacterSelect> = z.object({
...
export const CharacterFindFirstOrThrowSchema: z.ZodType<Prisma.CharacterFindFirstOrThrowArgs> = z.object({ select: CharacterFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CharacterIncludeObjectSchema.optional()), orderBy: z.union([CharacterOrderByWithRelationInputObjectSchema, CharacterOrderByWithRelationInputObjectSchema.array()]).optional(), where: CharacterWhereInputObjectSchema.optional(), cursor: CharacterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CharacterScalarFieldEnumSchema, CharacterScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CharacterFindFirstOrThrowArgs>;
