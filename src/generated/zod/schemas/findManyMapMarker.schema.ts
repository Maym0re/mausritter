...
export const MapMarkerFindManySelectSchema: z.ZodType<Prisma.MapMarkerSelect> = z.object({
...
export const MapMarkerFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    hexMapId: z.boolean().optional(),
    hexMap: z.boolean().optional(),
    image: z.boolean().optional(),
