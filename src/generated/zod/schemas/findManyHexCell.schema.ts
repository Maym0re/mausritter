...
export const HexCellFindManySelectSchema: z.ZodType<Prisma.HexCellSelect> = z.object({
...
export const HexCellFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    hexMapId: z.boolean().optional(),
    hexMap: z.boolean().optional(),
    q: z.boolean().optional(),
...
export const HexCellFindManySchema: z.ZodType<Prisma.HexCellFindManyArgs> = z.object({ select: HexCellFindManySelectSchema.optional(), include: z.lazy(() => HexCellIncludeObjectSchema.optional()), orderBy: z.union([HexCellOrderByWithRelationInputObjectSchema, HexCellOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexCellWhereInputObjectSchema.optional(), cursor: HexCellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexCellScalarFieldEnumSchema, HexCellScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HexCellFindManyArgs>;

export const HexCellFindManyZodSchema = z.object({ select: HexCellFindManySelectSchema.optional(), include: z.lazy(() => HexCellIncludeObjectSchema.optional()), orderBy: z.union([HexCellOrderByWithRelationInputObjectSchema, HexCellOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexCellWhereInputObjectSchema.optional(), cursor: HexCellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexCellScalarFieldEnumSchema, HexCellScalarFieldEnumSchema.array()]).optional() }).strict();