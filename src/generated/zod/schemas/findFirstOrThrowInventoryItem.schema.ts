...
export const InventoryItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.InventoryItemSelect> = z.object({
...
export const InventoryItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    characterId: z.boolean().optional(),
    character: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const InventoryItemFindFirstOrThrowSchema: z.ZodType<Prisma.InventoryItemFindFirstOrThrowArgs> = z.object({ select: InventoryItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => InventoryItemIncludeObjectSchema.optional()), orderBy: z.union([InventoryItemOrderByWithRelationInputObjectSchema, InventoryItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryItemWhereInputObjectSchema.optional(), cursor: InventoryItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryItemScalarFieldEnumSchema, InventoryItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InventoryItemFindFirstOrThrowArgs>;

export const InventoryItemFindFirstOrThrowZodSchema = z.object({ select: InventoryItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => InventoryItemIncludeObjectSchema.optional()), orderBy: z.union([InventoryItemOrderByWithRelationInputObjectSchema, InventoryItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryItemWhereInputObjectSchema.optional(), cursor: InventoryItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryItemScalarFieldEnumSchema, InventoryItemScalarFieldEnumSchema.array()]).optional() }).strict();