...
import { InventoryItemCharacterIdSlotTypeSlotIndexCompoundUniqueInputObjectSchema } from './InventoryItemCharacterIdSlotTypeSlotIndexCompoundUniqueInput.schema'
...
const makeSchema = () => z.object({
  ...
  characterId_slotType_slotIndex: z.lazy(() => InventoryItemCharacterIdSlotTypeSlotIndexCompoundUniqueInputObjectSchema).optional()
        ...
        const groups: string[][] = [["characterId","slotType","slotIndex"]] as string[][];
