...
import { WeatherEntrySeasonRollCompoundUniqueInputObjectSchema } from './WeatherEntrySeasonRollCompoundUniqueInput.schema'
...
const makeSchema = () => z.object({
  ...
  season_roll: z.lazy(() => WeatherEntrySeasonRollCompoundUniqueInputObjectSchema).optional()
        ...
        const groups: string[][] = [["season","roll"]] as string[][];
