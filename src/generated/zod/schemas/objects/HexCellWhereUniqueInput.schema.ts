...
import { HexCellHexMapIdQRSCompoundUniqueInputObjectSchema } from './HexCellHexMapIdQRSCompoundUniqueInput.schema'
...
const makeSchema = () => z.object({
  ...
  hexMapId_q_r_s: z.lazy(() => HexCellHexMapIdQRSCompoundUniqueInputObjectSchema).optional()
        ...
        const groups: string[][] = [["hexMapId","q","r","s"]] as string[][];
