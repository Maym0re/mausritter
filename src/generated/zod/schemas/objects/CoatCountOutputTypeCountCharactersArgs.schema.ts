...
export const CoatCountOutputTypeCountCharactersArgsObjectSchema = makeSchema();
export const CoatCountOutputTypeCountCharactersArgsObjectZodSchema = makeSchema();
