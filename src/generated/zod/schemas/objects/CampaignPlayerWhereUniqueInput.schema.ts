...
import { CampaignPlayerCampaignIdUserIdCompoundUniqueInputObjectSchema } from './CampaignPlayerCampaignIdUserIdCompoundUniqueInput.schema'
...
const makeSchema = () => z.object({
  ...
  campaignId_userId: z.lazy(() => CampaignPlayerCampaignIdUserIdCompoundUniqueInputObjectSchema).optional()
        ...
        const groups: string[][] = [["campaignId","userId"]] as string[][];
