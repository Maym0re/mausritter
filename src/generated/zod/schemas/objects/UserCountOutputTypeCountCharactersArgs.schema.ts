...
export const UserCountOutputTypeCountCharactersArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountCharactersArgsObjectZodSchema = makeSchema();
