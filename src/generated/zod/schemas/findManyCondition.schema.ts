...
export const ConditionFindManySelectSchema: z.ZodType<Prisma.ConditionSelect> = z.object({
...
export const ConditionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    clearRequirement: z.boolean().optional(),
