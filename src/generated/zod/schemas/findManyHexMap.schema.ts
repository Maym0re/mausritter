...
export const HexMapFindManySelectSchema: z.ZodType<Prisma.HexMapSelect> = z.object({
...
export const HexMapFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    campaignId: z.boolean().optional(),
    campaign: z.boolean().optional(),
    size: z.boolean().optional(),
...
export const HexMapFindManySchema: z.ZodType<Prisma.HexMapFindManyArgs> = z.object({ select: HexMapFindManySelectSchema.optional(), include: z.lazy(() => HexMapIncludeObjectSchema.optional()), orderBy: z.union([HexMapOrderByWithRelationInputObjectSchema, HexMapOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexMapWhereInputObjectSchema.optional(), cursor: HexMapWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexMapScalarFieldEnumSchema, HexMapScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HexMapFindManyArgs>;

export const HexMapFindManyZodSchema = z.object({ select: HexMapFindManySelectSchema.optional(), include: z.lazy(() => HexMapIncludeObjectSchema.optional()), orderBy: z.union([HexMapOrderByWithRelationInputObjectSchema, HexMapOrderByWithRelationInputObjectSchema.array()]).optional(), where: HexMapWhereInputObjectSchema.optional(), cursor: HexMapWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HexMapScalarFieldEnumSchema, HexMapScalarFieldEnumSchema.array()]).optional() }).strict();