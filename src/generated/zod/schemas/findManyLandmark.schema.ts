...
export const LandmarkFindManySelectSchema: z.ZodType<Prisma.LandmarkSelect> = z.object({
...
export const LandmarkFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    hexTypeId: z.boolean().optional(),
...
export const LandmarkFindManySchema: z.ZodType<Prisma.LandmarkFindManyArgs> = z.object({ select: LandmarkFindManySelectSchema.optional(), include: z.lazy(() => LandmarkIncludeObjectSchema.optional()), orderBy: z.union([LandmarkOrderByWithRelationInputObjectSchema, LandmarkOrderByWithRelationInputObjectSchema.array()]).optional(), where: LandmarkWhereInputObjectSchema.optional(), cursor: LandmarkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LandmarkScalarFieldEnumSchema, LandmarkScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LandmarkFindManyArgs>;

export const LandmarkFindManyZodSchema = z.object({ select: LandmarkFindManySelectSchema.optional(), include: z.lazy(() => LandmarkIncludeObjectSchema.optional()), orderBy: z.union([LandmarkOrderByWithRelationInputObjectSchema, LandmarkOrderByWithRelationInputObjectSchema.array()]).optional(), where: LandmarkWhereInputObjectSchema.optional(), cursor: LandmarkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LandmarkScalarFieldEnumSchema, LandmarkScalarFieldEnumSchema.array()]).optional() }).strict();